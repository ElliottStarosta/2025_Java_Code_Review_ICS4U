...
public class ChatResponse {
    ...
    public boolean isNeedsEmergencyCare() { return needsEmergencyCare; }
    public void setNeedsEmergencyCare(boolean needsEmergencyCare) { this.needsEmergencyCare = needsEmergencyCare; }
    
    public List<VetLocation> getNearbyVets() { return nearbyVets; }
    public void setNearbyVets(List<VetLocation> nearbyVets) { this.nearbyVets = nearbyVets; }
